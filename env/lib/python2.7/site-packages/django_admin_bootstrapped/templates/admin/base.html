...
<div class="container-fluid">
    ...
    <div id="content" class="{% block coltype %}colM{% endblock %}">
        ...
        <div class="col-sm-2 col-md-2 sidebar text-center">
        ...
        {% block sidebar %}
            ...
            <ul class="list list-unstyled">
                <li><a href="{% url 'admin:index' %}auth">Edit Employees</a></li>
                <li>Schedules</li>
                <li><a href="{% url 'admin:index' %}blog">Site Admin</a></li>
            </ul>
            <div class="sidebar-heading">
                Lab Assistant
            </div>
            <ul class="list list-unstyled">
                <li><a href="{% url 'admin:index' %}reports/annotation">Annotations</a></li>
                <li><a href="{% url 'admin:index' %}reports/troubleticket">Manage Trouble Tickets</a></li>
                <li><a href="{% url 'admin:index' %}reports/timesheeterror">View Time Sheet Errors</a></li>
                <li><a href="{% url 'admin:index' %}reports/printrefund">Manage Print Refunds</a></li>
            </ul>
            <div class="sidebar-heading">
                Lab Consultant
            </div>
            <ul class="list list-unstyled">
                <li><a href="{% url 'admin:index' %}reports/headcount">Headcounts</a></li>
                <li><a href="{% url 'admin:index' %}reports/troubleticket/add">Make Trouble Ticket</a></li>
                <li><a href="{% url 'admin:index' %}reports/timesheeterror/add">Time Sheet Error</a></li>
                <li><a href="{% url 'admin:index' %}schedule/event">Group Study Rooms</a></li>
                <li><a href="{% url 'admin:index' %}reports/printrefund/add">Print Refund Requests</a></li>
                <li><a href="{% url 'admin:index' %}reports/problemreport/add">Report a Problem</a></li>
            </ul>
        {% endblock sidebar %}
        </div>

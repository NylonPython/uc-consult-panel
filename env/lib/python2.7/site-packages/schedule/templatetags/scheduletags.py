...
@register.inclusion_tag("schedule/_daily_table_all.html", takes_context=True)
def daily_table_all(context, day, width, width_slot, height, start=8, end=20, increment=30, calendar=None):
    """
      Display a nice table with occurrences and action buttons.
      Arguments:
      width - width of the table (px)
